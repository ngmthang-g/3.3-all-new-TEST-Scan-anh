...
inline std::vector<Preset> CanonicalPresets(){
 ...
 {auto p=Base(L"Q1_ToChau",L"Biên Giới Tống Liêu",93,4,674,4400,8090,L"Một tên cũng không thể thoát");Pair(p.steps,L"Ngụy Tống Binh",93,1735,2478);Pair(p.steps,L"Ngụy Tống Quân Đô Thống",93,1760,1984,800,true);Pair(p.steps,L"Đào Thoán Phỉ Loại",93,1352,1348);Pair(p.steps,L"Ngụy Tống Quân Phó Đô Thống",93,2354,2351,800,true);Pair(p.steps,L"Dư Độc",93,1861,1865,800,true);p.steps.push_back(W(L"Chờ hoàn tất",10));a.push_back(std::move(p));}
