    ...
    Account* DungeonAccountByRoleID(std::int32_t roleID) {
    ...
    std::vector<Account*> DungeonStepMembers(DungeonTeamRuntime& team,
    ...
    void RefreshDungeonProgressPanel(DWORD now = GetTickCount()) {
        ...
        DungeonProgressAdd(L"Proof STEP", L"SCAN ALL GMonster VERIFIED • TASK manual-only");
