# AUTO Thần Long đa tính năng Pro v4.1
...
- Protocol EXE↔Bridge nâng lên `0x00040100`; source/EXE/DLL phải đi cùng bộ v4.1.
...
- `dist/AUTO_Than_Long_da_tinh_nang_Pro_v4.1.exe`
- `dist/ThanLongCleanRouteBridge.dll`
- `dist/AUTO-Than-Long-da-tinh-nang-Pro-v4.1-win-x64.zip`
- `dist/AUTO-Than-Long-da-tinh-nang-Pro-v4.1-source.zip`
- `dist/SHA256SUMS.txt`
