# AUTO Thần Long đa tính năng Pro v4.2
...
- `dist/AUTO_Than_Long_da_tinh_nang_Pro_v4.2.exe`
- `dist/ThanLongCleanRouteBridge.dll`
- `dist/AUTO-Than-Long-da-tinh-nang-Pro-v4.2-win-x64.zip`
- `dist/AUTO-Than-Long-da-tinh-nang-Pro-v4.2-source.zip`
- `dist/SHA256SUMS.txt`
